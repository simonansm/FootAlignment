"""Evaluation script for foot calf classification."""
...
from dataloaders.dataloader_calf import ImageMeasurementDataset
...
def main():
    ...
    checkpoint_path = root / "checkpoints" / "best_model_inception_calf.pt"
    ...
    labels = full_df["GT_label_calf"].values
    ...
    print_dataset_summary(full_df, MORPHOLOGICAL_FEATURES, "GT_label_calf", str(csv_file))
    print_split_class_distribution("Train", full_df.loc[train_idx, "GT_label_calf"].values)
    print_split_class_distribution("Validation", full_df.loc[val_idx, "GT_label_calf"].values)
    print_split_class_distribution("Test", full_df.loc[test_idx, "GT_label_calf"].values)
    ...
    print_bootstrap_summary("calf", bootstrap_result)
