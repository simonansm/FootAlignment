"""Training script for foot calf classification."""
...
def main():
    ...
    best_model_path = checkpoint_dir / "best_model_inception_calf.pt"
    ...
    train_loader, val_loader, test_loader, full_df, train_idx = load_data(
        csv_file, image_dir, "GT_label_calf", transform
    )
    
    # Class weights
    train_labels = full_df.loc[train_idx, "GT_label_calf"].values
